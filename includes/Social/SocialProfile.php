...
class SocialProfile
{
    ...
    public function __construct()
    {
        ...
        $this->multiProfileErrorMessage = esc_html__('Multi Profile is a Premium Feature. To use this feature, ', 'wp-scheduled-posts') . '<a href="https://wpdeveloper.net/in/wpsp">Upgrade to PRO.</a>';
    }
