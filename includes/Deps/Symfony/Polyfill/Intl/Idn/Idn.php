...
namespace WPSP\Deps\Symfony\Polyfill\Intl\Idn;

use WPSP\Deps\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges;
use WPSP\Deps\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex;
...
final class Idn
{
    ...
    public static function idn_to_ascii($domainName, $options = self::IDNA_DEFAULT, $variant = self::INTL_IDNA_VARIANT_UTS46, &$idna_info = [])
    {
        if (\PHP_VERSION_ID >= 70200 && self::INTL_IDNA_VARIANT_2003 === $variant) {
            _doing_it_wrong(  __METHOD__,  'idn_to_ascii(): INTL_IDNA_VARIANT_2003 is deprecated','1.0.0' );
        }
    ...
    {
        if (\PHP_VERSION_ID >= 70200 && self::INTL_IDNA_VARIANT_2003 === $variant) {
            _doing_it_wrong(  __METHOD__, 'idn_to_utf8(): INTL_IDNA_VARIANT_2003 is deprecated', '1.0.0' );
        }
    ...
    private static function process($domain, array $options, Info $info)
    {
        ...
        if (!\WPSP_Normalizer::isNormalized($domain, \WPSP_Normalizer::FORM_C)) {
            $domain = \WPSP_Normalizer::normalize($domain, \WPSP_Normalizer::FORM_C);
        }
    ...
    private static function validateLabel($label, Info $info, array $options, $canBeEmpty)
    {
        ...
        if (!\WPSP_Normalizer::isNormalized($label, \WPSP_Normalizer::FORM_C)) {
