        ...
        <div class="wpsp-modal-layout">
            ...
            <div class="wpsp-modal-left">
                <div class="wpsp-platform-icons">
                    <button class="wpsp-platform-icon facebook active has-data" title="Facebook" style="background-color: rgb(24, 119, 242); color: rgb(255, 255, 255); font-weight: bold; position: relative;">
                    ...
                    <button class="wpsp-platform-icon facebook  " title="Instagram" style="background-color: rgb(240, 240, 240); color: rgb(102, 102, 102); font-weight: normal; position: relative;">
                    ...
                    <button class="wpsp-platform-icon facebook  " title="Google_business" style="background-color: rgb(240, 240, 240); color: rgb(102, 102, 102); font-weight: normal; position: relative;">
