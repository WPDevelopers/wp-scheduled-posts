            ...
            <div class="wpsp-modal-layout">
                ...
                <div class="wpsp-modal-left">
                    ...
                    <div class="wpsp-custom-template-content-wrapper">
                        <div class="wpsp-profile-selection-area-wrapper" id="wpsp-profile-facebook">
                            ...
                            <div class="wpsp-profile-selection-dropdown">
                                <div class="wpsp-profile-selection-dropdown-item">
                                    <?php if ( ! empty( $facebookProfiles ) && is_array( $facebookProfiles ) ) : ?>
                                        <?php foreach ( $facebookProfiles as $profile ) : 
                                            // Default to profile thumbnail
                                            $thumbnail_url = ! empty( $profile->thumbnail_url ) ? $profile->thumbnail_url : $this->autho_logo;
                                            if ( ! empty( $profile->thumbnail_url ) ) {
                                                $response = wp_remote_head( $profile->thumbnail_url );
                                        ...
                                        <div class="wpsp-profile-card" data-profile-id="<?php echo esc_attr( $profile->id ); ?>" data-profile-name="<?php echo esc_attr( $profile->name ); ?>" data-profile-img="<?php echo esc_url( $thumbnail_url ); ?>">
                                            ...
                                            <div class="wpsp-profile-checkbox">
                                                <input
                                                    type="checkbox"
                                                    class="wpsp-modal-profile-checkbox"
                        ...
                        <div class="wpsp-profile-selection-area-wrapper" id="wpsp-profile-instagram" style="display: none;">
                            <div class="selected-profile-area">
                                <ul>
                                    <?php
                            ...
                            <div class="wpsp-profile-selection-dropdown">
                                <div class="wpsp-profile-selection-dropdown-item">
                                    <?php if ( ! empty( $instagramProfiles ) && is_array( $instagramProfiles ) ) : ?>
                                        <?php foreach ( $instagramProfiles as $profile ) :
                                             // Default to profile thumbnail
                                             $thumbnail_url = ! empty( $profile->thumbnail_url ) ? $profile->thumbnail_url : $this->autho_logo;
                                             if ( ! empty( $profile->thumbnail_url ) ) {
                                                 $response = wp_remote_head( $profile->thumbnail_url );
                                        ...
                                        <div class="wpsp-profile-card" data-profile-id="<?php echo esc_attr( $profile->id ); ?>" data-profile-name="<?php echo esc_attr( $profile->name ); ?>" data-profile-img="<?php echo esc_url( $thumbnail_url ); ?>">
                                            ...
                                            <div class="wpsp-profile-checkbox">
                                                <input
                                                    type="checkbox"
                                                    class="wpsp-modal-profile-checkbox wpsp-instagram-checkbox"
