<?php
/**
 * Facebook Tab Content for Social Message Modal
 * 
 * @package WPSP
 */
...
// Get Facebook profiles and selected data
$facebookProfiles = \WPSP\Helper::get_settings('facebook_profile_list');
$selected_facebook_profiles = isset($custom_templates['facebook']['profiles']) ? $custom_templates['facebook']['profiles'] : array();
$facebook_template = isset($custom_templates['facebook']['template']) ? $custom_templates['facebook']['template'] : '';
$facebook_is_global = isset($custom_templates['facebook']['is_global']) ? $custom_templates['facebook']['is_global'] : '';
?>

<!-- Facebook Profile Section -->
<div class="wpsp-profile-selection-area-wrapper" id="wpsp-profile-facebook" style="display: block;">
