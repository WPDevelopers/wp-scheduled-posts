<?php
/**
 * Twitter Tab Content for Social Message Modal
 * 
 * @package WPSP
 */
...
// Get Twitter profiles and selected data
$twitterProfiles = \WPSP\Helper::get_settings('twitter_profile_list');
$selected_twitter_profiles = isset($custom_templates['twitter']['profiles']) ? $custom_templates['twitter']['profiles'] : array();
$twitter_template = isset($custom_templates['twitter']['template']) ? $custom_templates['twitter']['template'] : '';
$twitter_is_global = isset($custom_templates['twitter']['is_global']) ? $custom_templates['twitter']['is_global'] : '';
?>
