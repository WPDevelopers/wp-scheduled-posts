<?php
/**
 * Instagram Tab Content for Social Message Modal
 * 
 * @package WPSP
 */
...
// Get Instagram profiles and selected data
$instagramProfiles = \WPSP\Helper::get_settings('instagram_profile_list');
$selected_instagram_profiles = isset($custom_templates['instagram']['profiles']) ? $custom_templates['instagram']['profiles'] : array();
$instagram_template = isset($custom_templates['instagram']['template']) ? $custom_templates['instagram']['template'] : '';
$instagram_is_global = isset($custom_templates['instagram']['is_global']) ? $custom_templates['instagram']['is_global'] : '';
?>
