<?php
/**
 * Pinterest Tab Content for Social Message Modal
 * 
 * @package WPSP
 */
...
// Get Pinterest profiles and selected data
$pinterestProfiles = \WPSP\Helper::get_settings('pinterest_profile_list');
$selected_pinterest_profiles = isset($custom_templates['pinterest']['profiles']) ? $custom_templates['pinterest']['profiles'] : array();
$pinterest_template = isset($custom_templates['pinterest']['template']) ? $custom_templates['pinterest']['template'] : '';
$pinterest_is_global = isset($custom_templates['pinterest']['is_global']) ? $custom_templates['pinterest']['is_global'] : '';
?>
