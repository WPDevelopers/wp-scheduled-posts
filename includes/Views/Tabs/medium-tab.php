<?php
/**
 * Medium Tab Content for Social Message Modal
 * 
 * @package WPSP
 */
...
// Get Medium profiles and selected data
$mediumProfiles = \WPSP\Helper::get_settings('medium_profile_list');
$selected_medium_profiles = isset($custom_templates['medium']['profiles']) ? $custom_templates['medium']['profiles'] : array();
$medium_template = isset($custom_templates['medium']['template']) ? $custom_templates['medium']['template'] : '';
$medium_is_global = isset($custom_templates['medium']['is_global']) ? $custom_templates['medium']['is_global'] : '';
?>
