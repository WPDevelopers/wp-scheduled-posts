<?php
/**
 * Threads Tab Content for Social Message Modal
 * 
 * @package WPSP
 */
...
// Get Threads profiles and selected data
$threadsProfiles = \WPSP\Helper::get_settings('threads_profile_list');
$selected_threads_profiles = isset($custom_templates['threads']['profiles']) ? $custom_templates['threads']['profiles'] : array();
$threads_template = isset($custom_templates['threads']['template']) ? $custom_templates['threads']['template'] : '';
$threads_is_global = isset($custom_templates['threads']['is_global']) ? $custom_templates['threads']['is_global'] : '';
?>
