...
const Sidebar = ({selectedPostType, draftEvents: posts, setDraftEvents: setPosts, calendar, getPostTypeColor, postType}: SidebarProps, draggableRef: MutableRefObject<HTMLDivElement>
  ) => {
