        ...
        return $this->normalize([
            ...
            'tabs' => apply_filters('wpsp_layout_tabs', [
                            ...
                            'fields' => [
                                ...
                                'linkedin_profile_list' => [
                                    ...
                                    'modal' => [
                                        ...
                                        /* translators: 1: Link to documentation for LinkedIn configuration, 2: Link to LinkedIn developer portal */
                                        'desc' => sprintf(__('For details on LinkedIn configuration, check out this <a href="%1$s" target="_blank">Doc</a>.<br> <a href="%2$s" target="_blank">Click here</a> to Retrieve Your API Keys from your LinkedIn account.', 'wp-scheduled-posts'), 'https://wpdeveloper.com/docs/share-wordpress-posts-on-linkedin/', 'https://developer.linkedin.com/'),
                                    ],
                                    'priority' => 15,
                                ],
                                'pinterest_profile_list' => [
                                    ...
                                    'modal' => [
                                        ...
                                        /* translators: 1: Link to documentation for Pinterest configuration, 2: Link to Pinterest developer portal */
                                        'desc' => sprintf(__('For details on Pinterest configuration, check out this <a href="%1$s" target="_blank">Doc</a>.<br> <a href="%2$s" target="_blank">Click here</a> to Retrieve Your API Keys from your Pinterest account.', 'wp-scheduled-posts'), 'https://wpdeveloper.com/docs/wordpress-posts-on-pinterest/', 'https://developers.pinterest.com/'),
                                    ],
                                    'priority' => 20,
                                ],
                                'instagram_profile_list' => [
                                    ...
                                    'modal' => [
                                        ...
                                        /* translators: 1: Link to documentation for Instagram configuration, 2: Link to Facebook developer portal */
                                        'desc' => sprintf(__('For details on Instagram configuration, check out this <a href="%1$s" target="_blank">Doc</a>.<br> <a href="%2$s" target="_blank">Click here</a> to Retrieve Your API Keys from your Instagram account.', 'wp-scheduled-posts'), 'https://wpdeveloper.com/docs/share-scheduled-wordpress-posts-on-instagram/', 'https://developers.facebook.com/'),
                                    ],
                                    'priority' => 25,
                                ],
                                'medium_profile_list' => [
                                    ...
                                    'modal' => [
                                        ...
                                        /* translators: 1: Link to documentation for Medium configuration, 2: Link to Medium settings */
                                        'desc' => sprintf(__('For details on Medium configuration, check out this <a href="%1$s" target="_blank">Doc</a>.<br> <a href="%2$s" target="_blank">Click here</a> to Retrieve Your API Keys from your Medium account.', 'wp-scheduled-posts'), 'https://wpdeveloper.com/docs/automatically-share-wordpress-posts-on-medium/', 'https://medium.com/me/settings/security/'),
                                    ],
                                    'priority' => 30,
                                ],
                                'threads_profile_list' => [
                                    ...
                                    'modal' => [
                                        'logo' => WPSP_ASSETS_URI . 'images/threads.svg',
                                        'redirect_url_desc' => __('Add this URL in the Redirect URLs field of your Medium app.', 'wp-scheduled-posts'),
                                        /* translators: 1: Link to documentation for Threads configuration, 2: Link to Facebook developer portal */
                                        'desc' => sprintf(__('For details on Threads configuration, check out this <a href="%1$s" target="_blank">Doc</a>.<br> <a href="%2$s" target="_blank">Click here</a> to Retrieve Your API Keys from your Threads account.', 'wp-scheduled-posts'), 'https://wpdeveloper.com/docs/automatically-share-wordpress-posts-on-threads/', 'https://developers.facebook.com/'),
                                    ],
                                    'priority' => 35,
                                ],
                                ...
                                'mastodon_profile_list'  => [
                                    'id'       => 'mastodon_profile_list',
                                    'name'     => 'mastodon_profile_list',
                                    'type'     => 'mastodon',
                                        ...
                                        'layouts_facebook' => [
                                            ...
                                            'fields' => [
                                                'facebook_wrapper' => [
                                                    ...
                                                    'priority' => 10,
                                                    /* translators: %s: Link to documentation for Facebook configuration */
                                        ...
                                        'layouts_mastodon'  => [
                                            ...
                                            'fields'        => [
                                                'mastodon_wrapper'     => [
                                                    'id'            => 'mastodon_wrapper',
                                                    'type'          => 'section',
                                                    'name'          => 'mastodon_wrapper',
                                                    'label'         => __('Mastodon Settings', 'wp-scheduled-posts'),
                                                    /* translators: %s: Link to documentation for Mastodon configuration */
                                                    'sub_title'     => sprintf( __('To configure the Mastodon Settings, check out this <a target="_blank" href="%s">Doc.</a>','wp-scheduled-posts'), 'https://wpdeveloper.com/docs/automatically-share-wordpress-posts-on-mastodon/' ),
                                                    'priority'      => 10,
                                                    'fields'        => [
                                                        'mastodon'  => [
                                                            'name'     => "mastodon",
                                                            ...
                                                            'fields'    => [
                                                                ...
                                                                'is_show_post_thumbnail'  => [
                                                                    'id'            => 'mastodon_show_post_thumbnail',
                                                                    'name'          => 'is_show_post_thumbnail',
                                                                    'type'          => 'toggle',
                                                                    'label'         => __('Show Featured Image', 'wp-scheduled-posts'),
                                                                    'info'          => __('Attach the featured image to the Mastodon post.','wp-scheduled-posts'),
                                                                    'priority'      => 11,
                                                                    'default'       => true,
                                                                ],
                                                                'content_source' => [
                                                                ...
                                                                'template_structure'  => [
                                                                    ...
                                                                    'type'          => 'text',
                                                                    'label'         => __('Status Template Settings', 'wp-scheduled-posts'),
                                                                    'info'          => __( 'Define how to share the content on Mastodon by setting the template. <strong>Default Structure: {title}{content}{url}{tags}</strong>','wp-scheduled-posts' ),
                                                                    'default'       => '{title}{content}{url}{tags}',
                                                                    'priority'      => 15,
                                                                ],
                                                                'note_limit'  => [
                                                                    'id'            => 'mastodon_note_limit',
                                                                    'name'          => 'note_limit',
                                                                    'type'          => 'number',
                                                                    'label'         => __('Status Limit', 'wp-scheduled-posts'),
                                                                    'priority'      => 20,
                ...
                'layout_ai' => [
                    'id' => 'layout_ai',
                    'name' => 'layout_ai',
                    'label' => __('Write With AI', 'wp-scheduled-posts'),
                    'priority' => 27,
                    'fields' => apply_filters('wpsp_ai_fields', [
                        'ai_section' => [
                            'id' => 'ai_section',
                            'name' => 'ai_section',
                            'type' => 'section',
                            ...
                            'fields' => [
                                'openai_api_key' => [
                                    ...
                                    'name' => 'openai_api_key',
                                    'type' => 'openai',
                                    'label' => __('OpenAI API Key', 'wp-scheduled-posts'),
                                    'default' => '',
                                    'priority' => 5,
                                ],
                            ],
                                ...
                                'tab_scheduling_hub' => [
                                    ...
                                    'fields' => [
                                        'layout_advance_schedule' => [
                                            ...
                                            'classes' => 'pro_feature',
                                            'fields' => [
                                                // The switch, then the video and
                                                // docs in a section of their own.
                                                ...
                                                'advance_schedule_resources' => [
                                                    'id' => 'advance_schedule_resources',
                                                    'name' => 'advance_schedule_resources',
                                                    'type' => 'resources',
                                                    'priority' => 15,
                                                    'label' => __('Learn how Advanced Schedule works', 'wp-scheduled-posts'),
                                                    'description' => __('A short walkthrough, plus a guide for each editor.', 'wp-scheduled-posts'),
                                                    ...
                                                    'content' => [
                                                        [
                                                            ...
                                                            'text' => __('Set up Advanced Schedule in Gutenberg', 'wp-scheduled-posts'),
                                                        ],
                                                        [
                                                            'link' => esc_url('https://wpdeveloper.com/docs/advanced-schedule-in-elementor/'),
                                                            'text' => __('Set up Advanced Schedule in Elementor', 'wp-scheduled-posts'),
                                                        ],
                                                        [
                                                            'link' => esc_url('https://wpdeveloper.com/docs/advanced-schedule-in-classic-editor/'),
                                                            'text' => __('Set up Advanced Schedule in the Classic Editor', 'wp-scheduled-posts'),
                                                        ],
                                                    ],
                                                ],
                                            ]
                                        ...
                                        'layout_missed_schedule' => [
                                            ...
                                            'fields' => [
                                                'is_active_missed_schedule' => [
                                                    ...
                                                    'sub_title' => __('Publish posts automatically when WordPress misses their scheduled time.', 'wp-scheduled-posts'),
                                                    'default' => 0,
                                                    'is_pro' => true,
                                                    'disabled_status' => "true",
                                                    'priority' => 5,
                                                ],
                                                'missed_schedule_resources' => [
                                                    'id' => 'missed_schedule_resources',
                                                    'name' => 'missed_schedule_resources',
                                                    'type' => 'resources',
                                                    'priority' => 15,
                                                    'label' => __('Learn how Missed Schedule works', 'wp-scheduled-posts'),
                                                    'description' => __('A short walkthrough, plus what causes the error and how SchedulePress handles it.', 'wp-scheduled-posts'),
                                                    ...
                                                    'content' => [
                                                        [
                                                            ...
                                                            'text' => __('Handle missed schedule errors with SchedulePress', 'wp-scheduled-posts'),
                                                        ],
                                                        [
                                                            'link' => esc_url('https://wpdeveloper.com/manage-missed-schedule-wordpress/'),
                                                            'text' => __('Why WordPress misses a scheduled post', 'wp-scheduled-posts'),
                                                        ],
                                                    ],
                                                ],
                                            ]
