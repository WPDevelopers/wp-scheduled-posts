                    ...
                    'fields'   => apply_filters('wpsp_general_fields',[
                        ...
                        'general_settings'     => [
                            ...
                            'fields'     => [
                                ...
                                'allow_post_type_for_share_on_publish'  => [
                                    'name'     => 'allow_post_type_for_share_on_publish',
                                    'label'    => __('Allow Post Type for Share on Publish:', 'wp-scheduled-posts'),
                                    'type'     => 'checkbox-select',
                                    'multiple' => true,
                                    'priority' => 45,
                                    'icon_classes'  => 'wpsp-icon wpsp-close',
                                ...
                                'set_future_date_on_post_publish' => [
                                    ...
                                    'type'        => 'toggle',
                                    'label'       => __('Set Future Date on Post Publish', 'wp-scheduled-posts'),
                                    'description' => __('Upgrade to Premium', 'wp-scheduled-posts'),
                                    'priority'    => 50,
                                    'default'     => false,
                                    'is_pro'      => true,
