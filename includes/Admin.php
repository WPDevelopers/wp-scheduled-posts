...
class Admin
{
    ...
    public function wpsp_register_metabox()
    {
        ...
        foreach ($allowed_post_types as $post_type) {
           add_meta_box(
                'wpsp_post_settings',
                '<img src="' . WPSP_ASSETS_URI . 'images/wpsp-logo.png" 
                    style="width:20px;height:20px;vertical-align:middle;margin-right:5px;margin:0;" /> ' 
                    . esc_html__('SchedulePress', 'wp-scheduled-posts'),
