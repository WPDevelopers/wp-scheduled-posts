...
class Admin
{
    ...
    public function __construct()
    {
        ...
        add_action( 'add_meta_boxes', [ $this, 'wpsp_register_metabox' ] );
    ...
    public function wpsp_register_metabox()
    {
        ...
        foreach ($allowed_post_types as $post_type) {
            add_meta_box(
                'wpsp_post_settings',
                '<svg width="20" height="20" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" class="components-panel__icon" aria-hidden="true" focusable="false"><path d="M9 18C4.04128 18 0 13.9587 0 9C0 4.04128 4.04128 0 9 0C10.5695 0 12.1011 0.401853 13.4431 1.18281C13.8602 1.42544 14.0042 1.94861 13.7616 2.35046C13.519 2.76748 12.9958 2.91154 12.5939 2.66891C11.5097 2.04718 10.2586 1.71356 9 1.71356C4.99663 1.72115 1.72873 4.98147 1.72873 8.98484C1.72873 12.9882 4.98905 16.2561 9 16.2561C11.0396 16.2561 12.92 15.4372 14.3075 13.9587C14.6335 13.6099 15.1794 13.5948 15.5206 13.9132C15.8694 14.2393 15.8846 14.7852 15.5661 15.1264C13.8677 16.9537 11.4794 17.9924 8.99242 17.9924L9 18Z" fill="url(#paint0_radial_1898_55)"></path><path d="M7.89382 7.24825L6.06653 5.58776C5.71775 5.26931 5.17184 5.29206 4.85339 5.64084C4.53494 5.98962 4.55768 6.53553 4.90646 6.85398L6.8854 8.65095C7.03704 8.0747 7.40099 7.5667 7.89382 7.24825Z" fill="#24E2AC"></path><path d="M18.8641 1.89593C18.5684 1.5244 18.0225 1.45616 17.651 1.75187L10.5996 7.32474C11.0697 7.67352 11.4109 8.1891 11.517 8.78809L18.7201 3.0939C19.1068 2.7982 19.1598 2.25987 18.8641 1.88834V1.89593Z" fill="#24E2AC"></path><path d="M9.93336 7.86338C9.71348 7.74207 9.46327 7.67383 9.19789 7.67383C8.95526 7.67383 8.73538 7.7269 8.53825 7.81789C7.99992 8.0681 7.64355 8.60643 7.64355 9.22817V9.32674C7.69663 10.138 8.36386 10.7825 9.19789 10.7825C10.0319 10.7825 10.6537 10.1835 10.7446 9.40256C10.7598 9.34948 10.7598 9.28124 10.7598 9.213C10.7598 8.63676 10.4338 8.12117 9.94094 7.8558L9.93336 7.86338Z" fill="#3DEAB5"></path><path d="M20.9114 7.00586H18.7429C18.5989 7.00586 18.4775 7.12717 18.4775 7.27123V9.1971C18.4775 9.34116 18.5989 9.46247 18.7429 9.46247H20.9114C21.0555 9.46247 21.1768 9.34116 21.1768 9.1971V7.27123C21.1768 7.12717 21.0555 7.00586 20.9114 7.00586Z" fill="#6C62FF"></path><path d="M17.3709 7.00586H15.2024C15.0583 7.00586 14.937 7.12717 14.937 7.27123V9.1971C14.937 9.34116 15.0583 9.46247 15.2024 9.46247H17.3709C17.5149 9.46247 17.6363 9.34116 17.6363 9.1971V7.27123C17.6438 7.12717 17.5301 7.00586 17.3709 7.00586Z" fill="#CCCCFF"></path><path d="M17.3709 10.1826H15.2024C15.0583 10.1826 14.937 10.3039 14.937 10.448V12.3739C14.937 12.5179 15.0583 12.6392 15.2024 12.6392H17.3709C17.5149 12.6392 17.6363 12.5179 17.6363 12.3739V10.448C17.6438 10.2963 17.5301 10.1826 17.3709 10.1826Z" fill="#CCCCFF"></path><path d="M20.9114 10.1826H18.7429C18.5989 10.1826 18.4775 10.3039 18.4775 10.448V12.3739C18.4775 12.5179 18.5989 12.6392 18.7429 12.6392H20.9114C21.0555 12.6392 21.1768 12.5179 21.1768 12.3739V10.448C21.1768 10.2963 21.0555 10.1826 20.9114 10.1826Z" fill="#CCCCFF"></path><defs><radialGradient id="paint0_radial_1898_55" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(15.9301 15.6268) scale(7.50632)"><stop stop-color="#F3F3FF"></stop><stop offset="0.09" stop-color="#E3E2FF"></stop><stop offset="0.4" stop-color="#B0ACFF"></stop><stop offset="0.66" stop-color="#8B84FF"></stop><stop offset="0.87" stop-color="#746CFF"></stop><stop offset="1" stop-color="#6C63FF"></stop></radialGradient></defs></svg> ' . esc_html__('SchedulePress', 'wp-scheduled-posts'),
    ...
    {
        if( file_exists( WPSCP_ADMIN_DIR_PATH . '/Metabox/index.php' ) ) {
            include_once WPSCP_ADMIN_DIR_PATH . '/Metabox/index.php';
        }
    }
    ...
    public function schedulepress_el_tab()
    {
        ...
        ?>
        <div id="wpsp-post-panel-modal" class="wpsp-post-panel-modal">
                    ...
                    <div class="elementor-templates-modal__header">
                        <div class="elementor-templates-modal__header__logo-area">
                            <div class="elementor-templates-modal__header__logo">
                                <img src="<?php echo plugins_url('assets/images/wpsp-el-editor-modal-logo.png', WPSP_PLUGIN_BASENAME); ?>"
                                    alt="<?php esc_html_e('WPSP Logo', 'wp-scheduled-posts'); ?>">
                            </div>
                        </div>
                        ...
                        <div class="elementor-templates-modal__header__items-area">
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                                    y="0px" viewBox="0 0 200 200" style="enable-background:new 0 0 200 200; width: 11px;"
                                    xml:space="preserve">
                                    <g>
        ...
        C195,198.8,192.5,199.8,189.9,199.8z" />
                ...
                <div class="dialog-message dialog-lightbox-message">
                    ...
                    <?php endif ?>
                    <div
                        class="dialog-content dialog-lightbox-content <?php echo !in_array(get_post_type(get_the_ID()), $allow_post_types) ? 'add-overlay' : '' ?>">
                        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post">
                            <div class="wpsp-el-fields-prev wpsp-el-fields active">
                                ...
                                <label>
                                    ...
                                    <input id="wpsp-schedule-datetime" type="text" name="date"
                                        value="<?php echo esc_attr($post_date) ?>" readonly>
                                </label>
                ...
                <div class="dialog-buttons-wrapper dialog-lightbox-buttons-wrapper wpsp-elementor-modal-wrapper">
                    ...
                    <div id="wpsp-el-form-update-button" class="wpsp_form_next_button_wrapper">
                        <button class="elementor-button wpsp-immediately-publish" style="<?php if (!$is_future) {
                            echo 'display: none;';
                        } ?>">
        ...
        <div id="elementor-panel-footer-sub-menu-item-wpsp" class="elementor-panel-footer-sub-menu-item tooltip-target"
            data-tooltip="<?php esc_attr_e('SchedulePress', 'wp-scheduled-posts'); ?>">
        ...
        <div id="elementor-panel-footer-wpsp-modal" class="elementor-panel-footer-tool tooltip-target"
            data-tooltip="<?php esc_attr_e('SchedulePress', 'wp-scheduled-posts'); ?>">
            <span id="elementor-panel-footer-wpsp-modal-label">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <style type="text/css">
                        ...
                        #elementor-panel-footer-wpsp-modal:hover .st0 {
                            fill: #d5dadf;
                        }
                    </style>
                    <g>
        ...
        <div class="wpsp-pro-fields">
            <label title="<?php esc_html_e('Pro Feature', 'wp-scheduled-posts'); ?>">
                <span><?php esc_html_e('Unpublish On', 'wp-scheduled-posts'); ?>
                    <a href="https://wpdeveloper.com/docs/advanced-schedule-update-published-posts/"
                        class="advance-schedule-info" target="_blank"><span class="dashicons dashicons-info"></span></a>
                    <span>
                ...
                <div class="wpsp-el-accordion">
                    <div class="wpsp-el-accordion-item wpsp-el-accordion-item-facebook">
                        <div class="wpsp-el-accordion-header">
                            <img src="<?php echo esc_url(WPSP_ASSETS_URI . '/images/facebook.svg') ?>"
                                alt=""><span><?php echo esc_html('Facebook') ?></span>
                        </div>
                        <div class="wpsp-el-accordion-content">
                            <?php if (!empty($facebookIntegation) && !empty($facebookProfile)): ?>
                                <div class="wpsp-el-container">
                                    <label><input type="radio" data-platform="facebook" name="wpsp-el-content-facebook"
                                            value="wpsp-el-social-facebook-default" <?php echo ((!empty($facebookShareType) && $facebookShareType == 'default') || empty($facebookShareType)) ? 'checked' : '' ?>><?php echo esc_html__('Default', 'wp-scheduled-posts') ?></label>
                                    <label><input type="radio" data-platform="facebook" name="wpsp-el-content-facebook"
                                            value="wpsp-el-social-facebook-custom" <?php echo !empty($facebookShareType) && $facebookShareType == 'custom' ? 'checked' : '' ?>><?php echo esc_html__('Custom', 'wp-scheduled-posts') ?></label>
                                </div>
                                <div class="wpsp-el-content wpsp-el-content-facebook" data-value="wpsp-el-social-facebook-custom"
                                    style="<?php echo !empty($facebookShareType) && $facebookShareType == 'custom' ? 'display: block;' : 'display: none;' ?>">
                                    <?php if (count($facebookProfile) > 0): ?>
                                        <?php foreach ($facebookProfile as $facebook): ?>
                                            <div class="facebook-profile social-profile">
                                                <input type="checkbox" value="<?php echo !empty($facebook->name) ? $facebook->name : '' ?>"
                                                    name="wpsp_el_social_facebook[]" <?php echo in_array($facebook->name, $filteredSelectedProfiles) ? 'checked' : '' ?>>
                                                <h3><?php echo !empty($facebook->name) ? $facebook->name : '' ?> (
                                                    <?php echo $facebook->type ? $facebook->type : '' ?> )
                                                </h3>
                                            </div>
                                        <?php endforeach ?>
                                    <?php endif ?>
                    ...
                    <div class="wpsp-el-accordion-item wpsp-el-accordion-item-twitter">
                        <div class="wpsp-el-accordion-header">
                            <img src="<?php echo esc_url(WPSP_ASSETS_URI . '/images/twitter.svg') ?>"
                                alt=""><span><?php echo esc_html('Twitter') ?></span>
                        </div>
                        <div class="wpsp-el-accordion-content">
                            <?php if (!empty($twitterIntegation) && !empty($twitterProfile)): ?>
                                <div class="wpsp-el-container">
                                    <label><input type="radio" data-platform="twitter" name="wpsp-el-content-twitter"
                                            value="wpsp-el-social-twitter-default" <?php echo ((!empty($twitterShareType) && $twitterShareType == 'default') || empty($twitterShareType)) ? 'checked' : '' ?>><?php echo esc_html__('Default', 'wp-scheduled-posts') ?></label>
                                    <label><input type="radio" data-platform="twitter" name="wpsp-el-content-twitter"
                                            value="wpsp-el-social-twitter-custom" <?php echo !empty($twitterShareType) && $twitterShareType == 'custom' ? 'checked' : '' ?>><?php echo esc_html__('Custom', 'wp-scheduled-posts') ?></label>
                                </div>
                                <div class="wpsp-el-content wpsp-el-content-twitter" data-value="wpsp-el-social-twitter-custom"
                                    style="<?php echo !empty($twitterShareType) && $twitterShareType == 'custom' ? 'display: block;' : 'display: none;' ?>">
                                    <?php if (count($twitterProfile) > 0): ?>
                                        <?php foreach ($twitterProfile as $twitter): ?>
                                            <div class="twitter-profile social-profile">
                                                <input type="checkbox" value="<?php echo !empty($twitter->name) ? $twitter->name : '' ?>"
                                                    name="wpsp_el_social_twitter[]" <?php echo in_array($twitter->name, $filteredSelectedProfiles) ? 'checked' : '' ?>>
                                                <h3><?php echo $twitter->name ? $twitter->name : '' ?> </h3>
                                            </div>
                                        <?php endforeach ?>
                                    <?php endif ?>
                                </div>
                    ...
                    <div class="wpsp-el-accordion-item wpsp-el-accordion-item-linkedin">
                        <div class="wpsp-el-accordion-header">
                            <img src="<?php echo esc_url(WPSP_ASSETS_URI . '/images/linkedin.svg') ?>"
                                alt=""><span><?php echo esc_html('LinkedIn') ?></span>
                        </div>
                        <div class="wpsp-el-accordion-content">
                            <div class="wpsp-el-custom-linkedin-tab">
                                <div class="wpsp-el-container wpsp-el-social-linkedin-tab-wrapper wpsp-pro-fields">
                                    <label for="wpsp-el-social-linkedin-profile-tab" class="active">
                                        <input type="radio" data-platform="linkedin-tab"
                                            id="wpsp-el-social-linkedin-profile-tab" name="wpsp-el-content-linkedin-tab"
                                            value="wpsp-el-social-linkedin-profile"
                                            checked><?php echo esc_html__('Profile', 'wp-scheduled-posts') ?>
                                    </label>
                                    <label for="wpsp-el-social-linkedin-page-tab"
                                        class="<?php echo !class_exists('WPSP_PRO') ? 'disabled' : '' ?>">
                                        <input type="radio" data-platform="linkedin-tab" id="wpsp-el-social-linkedin-page-tab"
                                            name="wpsp-el-content-linkedin-tab" value="wpsp-el-social-linkedin-page" <?php echo !class_exists('WPSP_PRO') ? 'disabled' : '' ?>><?php echo esc_html__('Page', 'wp-scheduled-posts') ?>
                                ...
                                <?php if (!empty($linkedinIntegation) && !empty($linkedinIntegation)): ?>
                                    <div class="wpsp-el-content wpsp-el-content-linkedin wpsp-el-social-linkedin-profile"
                                        data-value="wpsp-el-social-linkedin-profile" style="display: block;">
                                        <?php if (count($linkedinProfile) > 0): ?>
                                            ...
                                            <?php if ($count != 0): ?>
                                                <div class="wpsp-el-container">
                                                    <label><input type="radio" data-platform="linkedin-profile"
                                                            name="wpsp-el-content-linkedin-profile"
                                                            value="wpsp-el-social-linkedin-profile-default" <?php echo ((!empty($linkedinShareType) && $linkedinShareType == 'default') || empty($linkedinShareType)) ? 'checked' : '' ?>><?php echo esc_html__('Default', 'wp-scheduled-posts') ?></label>
                                                    <label><input type="radio" data-platform="linkedin-profile"
                                                            name="wpsp-el-content-linkedin-profile"
                                                            value="wpsp-el-social-linkedin-profile-custom" <?php echo !empty($linkedinShareType) && $linkedinShareType == 'custom' ? 'checked' : '' ?>><?php echo esc_html__('Custom', 'wp-scheduled-posts') ?></label>
                                                </div>
                                                <div class="wpsp-el-content wpsp-el-content-linkedin-profile"
                                                    data-value="wpsp-el-social-linkedin-profile-custom"
                                                    style="<?php echo !empty($linkedinShareType) && $linkedinShareType == 'custom' ? 'display: block;' : 'display: none;' ?>">
                                                    <?php foreach ($linkedinProfile as $linkedin): ?>
                                                        <?php if ($linkedin->type == 'person'): ?>
                                                            <div class="linkedin-profile social-profile">
                                                                <input type="checkbox"
                                                                    value="<?php echo !empty($linkedin->name) ? $linkedin->name : '' ?>"
                                                                    name="wpsp_el_social_linkedin[]" <?php echo in_array($linkedin->name, $filteredSelectedProfiles) ? 'checked' : '' ?>>
                                                                <h3><?php echo isset($linkedin->name) ? $linkedin->name : '' ?>
                                                                    <?php echo esc_html__('(Profile)', 'wp-scheduled-posts') ?>
                                                                </h3>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php endforeach ?>
                                    ...
                                    <div class="wpsp-el-content wpsp-el-content-linkedin wpsp-el-social-linkedin-page"
                                        data-value="wpsp-el-social-linkedin-page" style="display: none;">
                                        <?php if (count($linkedinProfile) > 0 && class_exists('WPSP_PRO')): ?>
                                            ...
                                            <?php if ($count != 0): ?>
                                                <div class="wpsp-el-container">
                                                    <label><input type="radio" data-platform="linkedin-page"
                                                            name="wpsp-el-content-linkedin-page"
                                                            value="wpsp-el-social-linkedin-page-default" <?php echo ((!empty($linkedinShareTypePage) && $linkedinShareTypePage == 'default') || empty($linkedinShareTypePage)) ? 'checked' : '' ?>><?php echo esc_html__('Default', 'wp-scheduled-posts') ?></label>
                                                    <label><input type="radio" data-platform="linkedin-page"
                                                            name="wpsp-el-content-linkedin-page" value="wpsp-el-social-linkedin-page-custom"
                                                            <?php echo !empty($linkedinShareTypePage) && $linkedinShareTypePage == 'custom' ? 'checked' : '' ?>><?php echo esc_html__('Custom', 'wp-scheduled-posts') ?></label>
                                                </div>
                                                <div class="wpsp-el-content wpsp-el-content-linkedin-page"
                                                    data-value="wpsp-el-social-linkedin-page-custom"
                                                    style="<?php echo !empty($linkedinShareTypePage) && $linkedinShareTypePage == 'custom' ? 'display: block;' : 'display: none;' ?>">
                                                    <?php foreach ($linkedinProfile as $linkedin): ?>
                                                        <?php if ($linkedin->type == 'organization'): ?>
                                                            <div class="linkedin-profile social-profile">
                                                                <input type="checkbox"
                                                                    ...
                                                                    name="wpsp_el_social_linkedin[]" <?php echo in_array($linkedin->name, $filteredSelectedProfiles) ? 'checked' : '' ?>>
                                                                <h3><?php echo isset($linkedin->name) ? $linkedin->name : '' ?>
                                                                    <?php echo esc_html__('(Page)', 'wp-scheduled-posts') ?>
                                                                </h3>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php endforeach ?>
                    ...
                    <div class="wpsp-el-accordion-item wpsp-el-accordion-item-pinterest">
                        <div class="wpsp-el-accordion-header">
                            <img src="<?php echo esc_url(WPSP_ASSETS_URI . '/images/pinterest.svg') ?>"
                                alt=""><span><?php echo esc_html('Pinterest') ?></span>
                        </div>
                        <div class="wpsp-el-accordion-content">
                            <?php if (!empty($pinterestIntegation) && !empty($pinterestIntegation)): ?>
                                <div class="wpsp-el-container">
                                    <label><input type="radio" data-platform="pinterest" name="wpsp-el-content-pinterest"
                                            value="wpsp-el-social-pinterest-default" <?php echo ((!empty($pinterestShareType) && $pinterestShareType == 'default') || empty($pinterestShareType)) ? 'checked' : '' ?>><?php echo esc_html__('Default', 'wp-scheduled-posts') ?></label>
                                    <label><input type="radio" data-platform="pinterest" name="wpsp-el-content-pinterest"
                                            value="wpsp-el-social-pinterest-custom" <?php echo !empty($pinterestShareType) && $pinterestShareType == 'custom' ? 'checked' : '' ?>><?php echo esc_html__('Custom', 'wp-scheduled-posts') ?></label>
                                </div>
                                <div class="wpsp-el-content wpsp-el-content-pinterest" data-value="wpsp-el-social-pinterest-custom"
                                    style="<?php echo !empty($pinterestShareType) && $pinterestShareType == 'custom' ? 'display: block;' : 'display: none;' ?>">
                                    <?php if (count($pinterestProfile) > 0): ?>
                                        <?php foreach ($pinterestProfile as $key => $pinterest): ?>
                                            ...
                                            <div class="pinterest-profile social-profile">
                                                <input type="checkbox" value="<?php echo $pinterest->default_board_name->value ?>"
                                                    name="wpsp_el_social_pinterest[]" <?php echo in_array($pinterest->default_board_name->label, $filteredSelectedProfiles) ? 'checked' : '' ?>>
                                                <h3><?php echo !empty($pinterest->default_board_name->label) ? $pinterest->default_board_name->label : '' ?>
                                                </h3>
                                                <select name="wpsp_el_pinterest_board[]"
                                                    id="wpsp_el_pinterest_section_<?php echo $pinterest->default_board_name->value ?>">
                                                    ...
                                                    <?php if (!empty($get_pinterest_sections)): ?>
                                                        <?php foreach ($get_pinterest_sections as $section): ?>
                                                            <?php if (!empty($getPinterestSections[$pinterest->default_board_name->value])): ?>
                                                                <option
                                                                    value="<?php echo !empty($section['id']) ? $section['id'] . '|' . $pinterest->default_board_name->value : '' ?>"
                                                                    <?php echo $getPinterestSections[$pinterest->default_board_name->value] == $section['id'] ? 'selected' : '' ?>><?php echo !empty($section['name']) ? $section['name'] : '' ?>
                                                                </option>
                                                            <?php endif ?>
                                                        <?php endforeach ?>
                                                    <?php endif ?>
                    ...
                    <div class="wpsp-el-accordion-item wpsp-el-accordion-item-instagram">
                        <div class="wpsp-el-accordion-header">
                            <img src="<?php echo esc_url(WPSP_ASSETS_URI . '/images/instagram.png') ?>"
                                alt=""><span><?php echo esc_html('Instagram') ?></span>
                        </div>
                        <div class="wpsp-el-accordion-content">
                            <?php if (!empty($instagramIntegation) && !empty($instagramProfile)): ?>
                                <div class="wpsp-el-container">
                                    <label><input type="radio" data-platform="instagram" name="wpsp-el-content-instagram"
                                            value="wpsp-el-social-instagram-default" <?php echo ((!empty($instagramShareType) && $instagramShareType == 'default') || empty($instagramShareType)) ? 'checked' : '' ?>><?php echo esc_html__('Default', 'wp-scheduled-posts') ?></label>
                                    <label><input type="radio" data-platform="instagram" name="wpsp-el-content-instagram"
                                            value="wpsp-el-social-instagram-custom" <?php echo !empty($instagramShareType) && $instagramShareType == 'custom' ? 'checked' : '' ?>><?php echo esc_html__('Custom', 'wp-scheduled-posts') ?></label>
                                </div>
                                <div class="wpsp-el-content wpsp-el-content-instagram" data-value="wpsp-el-social-instagram-custom"
                                    style="<?php echo !empty($instagramShareType) && $instagramShareType == 'custom' ? 'display: block;' : 'display: none;' ?>">
                                    <?php if (count($instagramProfile) > 0): ?>
                                        <?php foreach ($instagramProfile as $instagram): ?>
                                            <div class="instagram-profile social-profile">
                                                <input type="checkbox"
                                                    value="<?php echo !empty($instagram->name) ? $instagram->name : '' ?>"
                                                    name="wpsp_el_social_instagram[]" <?php echo in_array($instagram->name, $filteredSelectedProfiles) ? 'checked' : '' ?>>
                                                <h3><?php echo !empty($instagram->name) ? $instagram->name : '' ?> (
                                                    <?php echo $instagram->type ? $instagram->type : '' ?> )
                                                </h3>
                                            </div>
                                        <?php endforeach ?>
                                    <?php endif ?>
                    ...
                    <div class="wpsp-el-accordion-item wpsp-el-accordion-item-medium">
                        <div class="wpsp-el-accordion-header">
                            <img src="<?php echo esc_url(WPSP_ASSETS_URI . '/images/medium.svg') ?>" width="25"
                                alt=""><span><?php echo esc_html('Medium') ?></span>
                        </div>
                        <div class="wpsp-el-accordion-content">
                            <?php if (!empty($mediumIntegation) && !empty($mediumProfile)): ?>
                                <div class="wpsp-el-container">
                                    <label><input type="radio" data-platform="medium" name="wpsp-el-content-medium"
                                            value="wpsp-el-social-medium-default" <?php echo ((!empty($mediumShareType) && $mediumShareType == 'default') || empty($mediumShareType)) ? 'checked' : '' ?>><?php echo esc_html__('Default', 'wp-scheduled-posts') ?></label>
                                    <label><input type="radio" data-platform="medium" name="wpsp-el-content-medium"
                                            value="wpsp-el-social-medium-custom" <?php echo !empty($mediumShareType) && $mediumShareType == 'custom' ? 'checked' : '' ?>><?php echo esc_html__('Custom', 'wp-scheduled-posts') ?></label>
                                </div>
                                <div class="wpsp-el-content wpsp-el-content-medium" data-value="wpsp-el-social-medium-custom"
                                    style="<?php echo !empty($mediumShareType) && $mediumShareType == 'custom' ? 'display: block;' : 'display: none;' ?>">
                                    <?php if (count($mediumProfile) > 0): ?>
                                        <?php foreach ($mediumProfile as $medium): ?>
                                            <div class="medium-profile social-profile">
                                                <input type="checkbox" value="<?php echo !empty($medium->name) ? $medium->name : '' ?>"
                                                    name="wpsp_el_social_medium[]" <?php echo in_array($medium->name, $filteredSelectedProfiles) ? 'checked' : '' ?>>
                                                <h3><?php echo !empty($medium->name) ? $medium->name : '' ?> (
                                                    <?php echo $medium->type ? $medium->type : '' ?> )
                                                </h3>
                                            </div>
                                        <?php endforeach ?>
                                    <?php endif ?>
                    ...
                    <div class="wpsp-el-accordion-item wpsp-el-accordion-item-threads">
                        <div class="wpsp-el-accordion-header">
                            <img src="<?php echo esc_url(WPSP_ASSETS_URI . '/images/threads.svg') ?>" width="25"
                                alt=""><span><?php echo esc_html('Threads') ?></span>
                        </div>
                        <div class="wpsp-el-accordion-content">
                            <?php if (!empty($threadsIntegation) && !empty($threadsProfile)): ?>
                                <div class="wpsp-el-container">
                                    <label><input type="radio" data-platform="threads" name="wpsp-el-content-threads"
                                            value="wpsp-el-social-threads-default" <?php echo ((!empty($threadsShareType) && $threadsShareType == 'default') || empty($threadsShareType)) ? 'checked' : '' ?>><?php echo esc_html__('Default', 'wp-scheduled-posts') ?></label>
                                    <label><input type="radio" data-platform="threads" name="wpsp-el-content-threads"
                                            value="wpsp-el-social-threads-custom" <?php echo !empty($threadsShareType) && $threadsShareType == 'custom' ? 'checked' : '' ?>><?php echo esc_html__('Custom', 'wp-scheduled-posts') ?></label>
                                </div>
                                <div class="wpsp-el-content wpsp-el-content-threads" data-value="wpsp-el-social-threads-custom"
                                    style="<?php echo !empty($threadsShareType) && $threadsShareType == 'custom' ? 'display: block;' : 'display: none;' ?>">
                                    <?php if (count($threadsProfile) > 0): ?>
                                        <?php foreach ($threadsProfile as $threads): ?>
                                            <div class="threads-profile social-profile">
                                                <input type="checkbox" value="<?php echo !empty($threads->name) ? $threads->name : '' ?>"
                                                    name="wpsp_el_social_threads[]" <?php echo in_array($threads->name, $filteredSelectedProfiles) ? 'checked' : '' ?>>
                                                <h3><?php echo !empty($threads->name) ? $threads->name : '' ?> (
                                                    <?php echo $threads->type ? $threads->type : '' ?> )
                                                </h3>
                                            </div>
                                        <?php endforeach ?>
                                    <?php endif ?>
