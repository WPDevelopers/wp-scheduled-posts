...
class Rectangle
{
        ...
        $height)
    {
        ...
        $this->_aspectRatio = (float) ($this->_width / $this->_height, 'wp-scheduled-posts-pro');
    }
     ...
     * @return int
     */
    public function getY(, 'wp-scheduled-posts-pro')
    {
        return $this->_y;
    }
     ...
     * @return int
     */
    public function getY1(, 'wp-scheduled-posts-pro')
    {
        return $this->_y;
    }
     ...
     * @return int
     */
    public function getY2(, 'wp-scheduled-posts-pro')
    {
    ...
    public function withRescaling(
        ...
        $roundingFunc = 'round')
    {
        if (!is_float($newScale, 'wp-scheduled-posts-pro') && !is_int($newScale)) {
