	...
	<div class="wpscp-social-tab">
		<ul class="wp-tab-bar">
			<li class="wp-tab-active">
				<a href="#facebook">
					<img src="<?php echo esc_url(WPSP_ASSETS_URI . 'images/icon-facebook-small.png'); ?>" alt="<?php esc_attr_e('icon', 'wp-scheduled-posts-pro'); ?>">
					<?php
			...
			<li>
				<a href="#twitter">
					<img src="<?php echo esc_url(WPSP_ASSETS_URI . 'images/icon-twitter-small.png'); ?>" alt="<?php esc_attr_e('icon', 'wp-scheduled-posts-pro'); ?>">
					<?php
			...
			<li>
				<a href="#linkedin">
					<img src="<?php echo esc_url(WPSP_ASSETS_URI . 'images/icon-linkedin-small.png'); ?>" alt="<?php esc_attr_e('icon', 'wp-scheduled-posts-pro'); ?>">
					<?php
			...
			<li>
				<a href="#pinterest">
					<img src="<?php echo esc_url(WPSP_ASSETS_URI . 'images/icon-pinterest-small.png'); ?>" alt="<?php esc_attr_e('icon', 'wp-scheduled-posts-pro'); ?>">
					<?php
		...
		<div class="wp-tab-panel" id="facebook">
			...
			<div class="wpscp-social-tab__item-header wpscp-social-tab__item-header--facebook">
				<div class="entry-icon">
					<img src="<?php echo esc_url(WPSP_ASSETS_URI . 'images/icon-facebook.png'); ?>" alt="<?php esc_attr_e('icon', 'wp-scheduled-posts-pro'); ?>">
				</div>
		...
		<div class="wp-tab-panel" id="twitter" style="display: none;">
			...
			<div class="wpscp-social-tab__item-header wpscp-social-tab__item-header--twitter">
				<div class="entry-icon">
					<img src="<?php echo esc_url(WPSP_ASSETS_URI . 'images/icon-twitter.png'); ?>" alt="<?php esc_attr_e('icon', 'wp-scheduled-posts-pro'); ?>">
				</div>
				<div class="entry-content">
		...
		<div class="wp-tab-panel" id="linkedin" style="display: none;">
			...
			<div class="wpscp-social-tab__item-header wpscp-social-tab__item-header--linkedin">
				<div class="entry-icon">
					<img src="<?php echo esc_url(WPSP_ASSETS_URI . 'images/icon-linkedin.png'); ?>" alt="<?php esc_attr_e('icon', 'wp-scheduled-posts-pro'); ?>">
				</div>
				<div class="entry-content">
		...
		<div class="wp-tab-panel" id="pinterest" style="display: none;">
			...
			<div class="wpscp-social-tab__item-header wpscp-social-tab__item-header--pinterest">
				<div class="entry-icon">
					<img src="<?php echo esc_url(WPSP_ASSETS_URI . 'images/icon-pinterest.png'); ?>" alt="<?php esc_attr_e('icon', 'wp-scheduled-posts-pro'); ?>">
				</div>
				<div class="entry-content">
