		...
		<div class="wpsp-form-wrap">
			...
			if (!$pluginVersion) {
				...
				?>
						...
						<div class="wpsp-checkbox-wrapper">
							<div class="checkbox-toggle">
							<input type="checkbox" id="pub_check" name="pub_check" value="<?php if (!empty($activate_pub_option)) {
																																																																					echo $activate_pub_option;
																																																																				} else {
																																																																					echo 'ok';
																																																																				} ?>" <?php if (get_option('pub_active_option')) {
...
//start here
    ...
    //select psm_manage_schedule data
				...
				?>
						<div class="wpsp-checkbox-wrapper">
							<div class="checkbox-toggle">
							<input type="checkbox" id="cal_check" name="cal_check" value="<?php if (!empty($activate_cal_option)) {
																																																																					echo $activate_cal_option;
																																																																				} else {
																																																																					echo 'ok';
																																																																				} ?>" <?php if (get_option('cal_active_option')) {
																																																																																																																																																															echo 'checked="checked"';
																																																																																																																																																														} ?> >
								<svg class="is_checked" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 426.67 426.67">
								<path d="M153.504 366.84c-8.657 0-17.323-3.303-23.927-9.912L9.914 237.265c-13.218-13.218-13.218-34.645 0-47.863 13.218-13.218 34.645-13.218 47.863 0l95.727 95.727 215.39-215.387c13.218-13.214 34.65-13.218 47.86 0 13.22 13.218 13.22 34.65 0 47.863L177.435 356.928c-6.61 6.605-15.27 9.91-23.932 9.91z"/>
			...
			?>
						...
						<form action=""  method="post">
							...
							<h2 class="wpsp-notice-text"><?php if (isset($massage)) {
																																				echo $massage;
																																			} ?></h2>
...
// loop of friday data
						...
						?>
									<input type="checkbox" name="miss_check" value="<?php if (!empty($activate_miss_option)) {
																																																									echo $activate_miss_option;
																																																								} else {
																																																									echo 'miss';
																																																								} ?>" <?php if (isset($_POST['miss_check']) || !empty($activate_miss_option)) {
																																																																																																																																																							echo 'checked="checked"';
																																																																																																																																																						} ?> ><label for="miss_check">Activate Missed Schedule</label>
									<p class="wpsp-description-text">WordPress might miss the schedule for a post for various reason. If enabled, <strong>WP Scheduled Posts</strong> will take care of this to publish the missed schedule.</p>
