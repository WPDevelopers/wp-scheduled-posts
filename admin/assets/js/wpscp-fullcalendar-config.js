  ...
  //center any element in jquery center function
    ...
    */
    ...
    function wpscpEventTemplateStructure(obj){
            var trimTitle = (obj.post_title != "" ? ((obj.post_title.length > 20) ? obj.post_title.slice(0, 20) + "..." : obj.post_title) : '');
            var markup = '';
            markup +='<div class="wpscp-event-post" data-postid="'+obj.ID+'">';
            markup +='<div class="postlink "><span><span class="posttime">['+wpscpFormatAMPM(new Date(obj.post_date))+']</span> '+trimTitle+' ['+obj.post_status+']</span></div>';
            var link = '';
