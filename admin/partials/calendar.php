        ...
        <div class="full-calendar-wrapper">
            <div id='calendar-container'>
                <div id='external-events'>
                        ...
                        <div class='fc-event'>
                            <div class="wpscp-event-post" data-postid="<?php print get_the_id(); ?>">
                                ...
                                <div class="postactions">
                                    <div>
                                        <div class="edit">
                                            <a href="<?php print esc_url(get_edit_post_link(get_the_id())); ?>"><?php esc_html_e('Edit', 'wp-scheduled-posts'); ?></a>
                                            <a class="wpscpquickedit" href="#" data-type="quickedit"><?php esc_html_e('Quick Edit', 'wp-scheduled-posts'); ?></a>
                                        </div>
                                        <div class="deleteview">
                                            <a class="wpscpEventDelete" href="#"><?php esc_html_e('Delete', 'wp-scheduled-posts'); ?></a>
                                            <a href="<?php print esc_url(get_the_permalink()); ?>"><?php esc_html_e('View', 'wp-scheduled-posts'); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <p><a href="#wpscp_quickedit" rel="modal:open" data-type="draft"><?php esc_html_e('New Draft', 'wp-scheduled-posts'); ?></a></p>
                </div>
                <div id='calendar'></div>
            </div>
        </div>
