...
= 5.3.1 - 2026-06-30 =
- Added: Social share caption generate using AI.
- Fixed: Undefined variable $template_structure for Google Business Profile
- Fixed: Google My Business social share wasn't working properly.
- Fixed: Connected Social Profiles auto selection wasn't working.
- Fixed: Publish post immediately wasn't working properly.
- Few minor bug fixes and improvements

= 5.3.0 - 2026-05-17 =
- Added: WordPress 7.0 compatibility
- Revamped: Centralized scheduling process in SchedulePress.
- Fixed: Auto-changing post time issue from Calendar scheduling.
- Few minor bug fixes and improvements

= 5.2.18 - 2026-04-16 =
- Fixed: Default time issue in calendar post creation.
- Few minor bug fixes and improvements.

= 5.2.17 - 2026-03-16 =
- Fixed: Readable file error when sharing posts to Twitter (X).
- Few minor bug fixes and improvements
...
- Improved: Google Business connection process.
- Improved: Security enhancements.
- Few minor bug fixes & improvements
...
- Improved : Performance of Calendar Events View for smoother navigation.
- Few minor bug fixes & improvements

= 5.2.6 - 2025-05-14 =
- Fixed: Gutenberg publish issue due to invalid thumbnail URL in social profile.
- Improved: Removed duplicate controller that was loading unnecessarily.
- Few minor bug fixes and improvements.
...
- Improved: Enhanced Facebook social templates.
- Fixed: Resolved an issue where custom CSS code was being shared on social media.
- Few minor bug fixes & improvements

= 5.2.3 - 2025-02-23 =
- Fixed: Instagram post formatting issue
- Fixed: Duplicate draft posts on SchedulePress Calendar
- Fixed: JSON error while saving a post
- Fixed: Future-dated posts not publishing properly
- Fixed: Posts not sharing on LinkedIn profile and page
- Fixed: Text domain issue
- Improved: Auto-update for LinkedIn profile and page connection expiration
- Few minor bug fixes & improvements

= 5.2.2 - 2025-01-27 =
- Fixed: Post categories were being shared twice on social media.
- Fixed: Extra spaces were added when sharing posts on LinkedIn.
- Improved: Security enhancements.
- Few minor bug fixes and improvements.

= 5.2.1 - 2024-12-22 =
- Added: Taxonomy support for Post Types.
