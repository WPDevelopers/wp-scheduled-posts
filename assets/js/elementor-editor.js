(function ($) {
    ...
    $(document).ready(function() {
        const isElementorDisabled = wpscpSocialProfile?.show_on_elementor_editor;
        const activeIcon = `<svg width="20" height="20" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"><path d="M9 18C4.04128 18 0 13.9587 0 9C0 4.04128 4.04128 0 9 0C10.5695 0 12.1011 0.401853 13.4431 1.18281C13.8602 1.42544 14.0042 1.94861 13.7616 2.35046C13.519 2.76748 12.9958 2.91154 12.5939 2.66891C11.5097 2.04718 10.2586 1.71356 9 1.71356C4.99663 1.72115 1.72873 4.98147 1.72873 8.98484C1.72873 12.9882 4.98905 16.2561 9 16.2561C11.0396 16.2561 12.92 15.4372 14.3075 13.9587C14.6335 13.6099 15.1794 13.5948 15.5206 13.9132C15.8694 14.2393 15.8846 14.7852 15.5661 15.1264C13.8677 16.9537 11.4794 17.9924 8.99242 17.9924L9 18Z" fill="url(#paint0_radial_1898_55)"></path><path d="M7.89382 7.24825L6.06653 5.58776C5.71775 5.26931 5.17184 5.29206 4.85339 5.64084C4.53494 5.98962 4.55768 6.53553 4.90646 6.85398L6.8854 8.65095C7.03704 8.0747 7.40099 7.5667 7.89382 7.24825Z" fill="#24E2AC"></path><path d="M18.8641 1.89593C18.5684 1.5244 18.0225 1.45616 17.651 1.75187L10.5996 7.32474C11.0697 7.67352 11.4109 8.1891 11.517 8.78809L18.7201 3.0939C19.1068 2.7982 19.1598 2.25987 18.8641 1.88834V1.89593Z" fill="#24E2AC"></path><path d="M9.93336 7.86338C9.71348 7.74207 9.46327 7.67383 9.19789 7.67383C8.95526 7.67383 8.73538 7.7269 8.53825 7.81789C7.99992 8.0681 7.64355 8.60643 7.64355 9.22817V9.32674C7.69663 10.138 8.36386 10.7825 9.19789 10.7825C10.0319 10.7825 10.6537 10.1835 10.7446 9.40256C10.7598 9.34948 10.7598 9.28124 10.7598 9.213C10.7598 8.63676 10.4338 8.12117 9.94094 7.8558L9.93336 7.86338Z" fill="#3DEAB5"></path><path d="M20.9114 7.00586H18.7429C18.5989 7.00586 18.4775 7.12717 18.4775 7.27123V9.1971C18.4775 9.34116 18.5989 9.46247 18.7429 9.46247H20.9114C21.0555 9.46247 21.1768 9.34116 21.1768 9.1971V7.27123C21.1768 7.12717 21.0555 7.00586 20.9114 7.00586Z" fill="#6C62FF"></path><path d="M17.3709 7.00586H15.2024C15.0583 7.00586 14.937 7.12717 14.937 7.27123V9.1971C14.937 9.34116 15.0583 9.46247 15.2024 9.46247H17.3709C17.5149 9.46247 17.6363 9.34116 17.6363 9.1971V7.27123C17.6438 7.12717 17.5301 7.00586 17.3709 7.00586Z" fill="#CCCCFF"></path><path d="M17.3709 10.1826H15.2024C15.0583 10.1826 14.937 10.3039 14.937 10.448V12.3739C14.937 12.5179 15.0583 12.6392 15.2024 12.6392H17.3709C17.5149 12.6392 17.6363 12.5179 17.6363 12.3739V10.448C17.6438 10.2963 17.5301 10.1826 17.3709 10.1826Z" fill="#CCCCFF"></path><path d="M20.9114 10.1826H18.7429C18.5989 10.1826 18.4775 10.3039 18.4775 10.448V12.3739C18.4775 12.5179 18.5989 12.6392 18.7429 12.6392H20.9114C21.0555 12.6392 21.1768 12.5179 21.1768 12.3739V10.448C21.1768 10.2963 21.0555 10.1826 20.9114 10.1826Z" fill="#CCCCFF"></path><defs><radialGradient id="paint0_radial_1898_55" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(15.9301 15.6268) scale(7.50632)"><stop stop-color="#F3F3FF"></stop><stop offset="0.09" stop-color="#E3E2FF"></stop><stop offset="0.4" stop-color="#B0ACFF"></stop><stop offset="0.66" stop-color="#8B84FF"></stop><stop offset="0.87" stop-color="#746CFF"></stop><stop offset="1" stop-color="#6C63FF"></stop></radialGradient></defs></svg>`;
        const disabledIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" style="display:block;width:18px;margin:0 auto;fill:#A4AFB7;" aria-hidden="true" focusable="false"><g><g><path d="M212.3,462.4C95,462.4-0.4,366.9-0.4,249.7S95,37,212.3,37c37,0,73.2,9.6,105.1,27.9c9.8,5.7,13.2,18.1,7.5,27.7c-5.7,9.8-18.1,13.2-27.7,7.5c-25.6-14.7-55.1-22.5-84.9-22.5c-94.7,0-171.8,77.1-171.8,171.8s77.1,171.8,171.8,171.8c48.1,0,92.6-19.4,125.5-54.3c7.8-8.3,20.7-8.5,28.7-1c8.3,7.8,8.5,20.7,1,28.7C327.4,437.8,271,462.4,212.3,462.4z"/></g><path d="M186.1,208.3l-43.2-39.3c-8.3-7.5-21.2-7-28.7,1.3c-7.5,8.3-7,21.2,1.3,28.7l46.8,42.4C165.9,227.7,174.5,215.8,186.1,208.3z"/><path d="M445.4,81.7c-7-8.8-19.9-10.4-28.7-3.4L250,210.1c11.1,8.3,19.1,20.4,21.7,34.7L442,110.2C451.1,103.2,452.4,90.5,445.4,81.7z"/><path d="M234.3,222.8c-5.2-2.8-11.1-4.4-17.3-4.4c-5.7,0-10.9,1.3-15.5,3.4c-12.7,6-21.2,18.6-21.2,33.4c0,0.8,0,1.6,0,2.3c1.3,19.1,17.1,34.4,36.7,34.4c18.9,0,34.4-14.2,36.5-32.6c0.3-1.3,0.3-2.8,0.3-4.4C253.7,241.1,245.9,229,234.3,222.8z"/><path d="M493.8,202.6h-51.2c-3.4,0-6.2,2.8-6.2,6.2v45.5c0,3.4,2.8,6.2,6.2,6.2h51.2c3.4,0,6.2-2.8,6.2-6.2v-45.5C500,205.4,497.2,202.6,493.8,202.6z"/><g><path d="M410,202.6h-51.2c-3.4,0-6.2,2.8-6.2,6.2v45.5c0,3.4,2.8,6.2,6.2,6.2H410c3.4,0,6.2-2.8,6.2-6.2v-45.5C416.4,205.4,413.6,202.6,410,202.6z"/><path d="M410,277.6h-51.2c-3.4,0-6.2,2.8-6.2,6.2v45.5c0,3.4,2.8,6.2,6.2,6.2H410c3.4,0,6.2-2.8,6.2-6.2v-45.5C416.4,280.2,413.6,277.6,410,277.6z"/><path d="M493.8,277.6h-51.2c-3.4,0-6.2,2.8-6.2,6.2v45.5c0,3.4,2.8,6.2,6.2,6.2h51.2c3.4,0,6.2-2.8,6.2-6.2v-45.5C500,280.2,497.2,277.6,493.8,277.6z"/></g></g></svg>`;
        const iconHtml = isElementorDisabled ? activeIcon : disabledIcon;
        const buttonExtras = isElementorDisabled ? '' : ' disabled style="cursor: not-allowed; opacity: 0.6;"';
        setTimeout(() => {
            jQuery('#elementor-editor-wrapper-v2 .MuiBox-root .MuiGrid-root:first-child .MuiStack-root:last-child').append(`
                <div class="elementor-panel-footer-wpsp-modal"><span id="elementor-panel-footer-wpsp-modal-label" class="eui-box eui-tooltip MuiBox-root css-0"><button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium eui-icon-button wpsp-elementor-topbar-panel-button" tabindex="0" type="button" aria-label="Preview Changes"${buttonExtras}>${iconHtml}</button></span></div>`);
        }, 0);
    });
