        ...
        <div className="sc-publish-future">
          ...
          <div>
            <CheckboxControl
                ...
                onChange={ (checked) => this.setState({publishImmediately : checked}) }
            />
            <a id="wpscp-future-post-help-handler" href="javascript:void();" title="Show/Hide Help" onClick={() => {
          ...
          {
            this.state.showHelp &&
            <div>If you schedule this post and check this option then your post will be published immediately but post date-time will not set current date. Post date-time will be your scheduled future date-time.</div>
          }
        </div>
